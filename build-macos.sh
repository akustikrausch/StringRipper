...
# x86_64 slice (min macOS 10.13, no Metal - it is a CLI), and a universal binary.
#
...
echo "x86_64 (min macOS 10.13)"
clang++ $FLAGS -arch x86_64 -mmacosx-version-min=10.13 "$SRC" -o "$OUT/stringripper-x86_64"
